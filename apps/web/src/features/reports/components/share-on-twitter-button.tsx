...
import { SOCIAL_SHARE_BUTTON_CLASS } from '@/features/reports/constants'
...
export function ShareOnTwitterButton(summary: ReportShareSummary) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <a href={xUrl} target="_blank" rel="noopener noreferrer" className={SOCIAL_SHARE_BUTTON_CLASS}>
        <XIcon />
        Share on X
      </a>
      <a href={redditUrl} target="_blank" rel="noopener noreferrer" className={SOCIAL_SHARE_BUTTON_CLASS}>
        <RedditIcon />
        Share on Reddit
      </a>
    </div>
